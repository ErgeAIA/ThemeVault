...
> 来源项目：[JellyFish](https://github.com/pawelborkar/vscode-jellyfish)（Apache-2.0）
> © Pawel Borkar；海洋紫蓝调，粉红品牌（#ff0055）
> 数据源：`themes/JellyFish Theme-color-theme.json`（VS Code color theme JSON）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | JellyFish | dark | value theme | 海洋深蓝紫调，粉红品牌（#ff0055） |
