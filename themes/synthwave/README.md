...
> 来源项目：[robb0wen/synthwave-vscode](https://github.com/robb0wen/synthwave-vscode)（MIT（© Robb Owen））
> 数据源：themes/synthwave-color-theme.json（VS Code 主题 JSON：UI 语义键 `colors` + 语法 `tokenColors`）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Synthwave 84 | dark | value theme | 霓虹 dark |

> 霓虹风格；文本保持白色（README 明示）
