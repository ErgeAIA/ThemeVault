...
> 来源项目：[cocopon/vscode-iceberg-theme](https://github.com/cocopon/vscode-iceberg-theme)（MIT（© cocopon））
> 数据源：themes/iceberg.color-theme.json + iceberg-light.color-theme.json（VS Code 主题 JSON：UI 语义键 `colors` + 语法 `tokenColors`）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Iceberg | dark | value theme | 官方 dark |
| `light` | Iceberg Light | light | value theme | 官方 light |

> 官方 dark + light 双方案，低对比柔和
