...
> 来源项目：[Shades of Purple](https://github.com/ahmadawais/shades-of-purple-vscode)（MIT）
> © Ahmad Awais；紫色系高饱和，黄色品牌（#FAD000）
> 数据源：`themes/shades-of-purple-color-theme*.json`（VS Code color theme JSON，italic 为字体变体未单列）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Shades of Purple | dark | value theme | 默认紫调，黄品牌（#FAD000） |
| `super-dark` | Shades of Purple (Super Dark) | dark | value theme | 更暗背景变体（#191830） |
...
- `border`：取 `dropdown.border`
- `ok`：取 `terminal.ansiGreen`
