...
> 来源：Shades of Purple（MIT）`shades-of-purple.json`（dark）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#2D2B55` | 中性 | 来源 editor.background |
| `--bg-surface` | `#2D2B55` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#28284E` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#222244` | 中性 | 来源 editorWidget.background |
| `--bg-hover` | `#2D2B55` | 中性 | 来源 list.hoverBackground |
| `--text` | `#FFFFFF` | 中性 | 来源 editor.foreground |
| `--text-muted` | `#A599E9` | 中性 | 来源 editorLineNumber.foreground |
| `--text-dim` | `#A599E9` | 中性 | 继承 text-muted |
| `--border` | `#FAD000` | 中性 | 来源 panel.border |
| `--border-strong` | `#FAD000` | 中性 | 继承 border |
| `--border-focus` | `#1E1E3F` | 中性 | 来源 focusBorder |
| `--card` | `#222244` | 中性 | 继承 bg-elevated |
...
| `--accent-foreground` | `#222244` | 强调 | 来源 button.foreground |
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--selection` | `#B362FF88` | 派生 | 来源 editor.selectionBackground |
| `--selection-solid` | `#B362FF` | 派生 | 来源 selection.background |
