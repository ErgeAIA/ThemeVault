...
> 来源项目：[Omni](https://github.com/getomni/visual-studio-code)（MIT）
> © Rocketseat；深紫底（#191622）+ 粉红品牌（#FF79C6）
> 数据源：`src/omni.yml`（VS Code theme YAML 锚点体系 + !alpha 派生）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Omni | dark | value theme | Rocketseat 深紫调（#191622），粉红品牌（#FF79C6） |
