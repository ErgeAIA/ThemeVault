...
> 来源项目：[sdras/night-owl-vscode-theme](https://github.com/sdras/night-owl-vscode-theme)（MIT（© Sarah Drasner））
> 数据源：themes/Night Owl-color-theme.json + Night Owl-Light-color-theme.json（VS Code 主题 JSON：UI 语义键 `colors` + 语法 `tokenColors`）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Night Owl | dark | value theme | 官方 dark |
| `light` | Light Owl | light | value theme | 官方 light |
