...
> 来源项目：[Ayu](https://github.com/ayu-theme/vscode-ayu)（MIT）
> © Ayu；官方 3 方案（Light/Mirage/Dark），unbordered 为默认版
> 数据源：根目录 `ayu-*-unbordered.json`（VS Code color theme JSON，bordered 变体为同色边线版未单列）

## 家族成员

| 主题 ID | 显示名 | 方案 | 类型 | 说明 |
|---------|--------|------|------|------|
| `dark` | Ayu Dark | dark | value theme | 官方暗色，琥珀金品牌（focus/按钮 #e6b450） |
| `mirage` | Ayu Mirage | dark | value theme | 官方 mirage 暗紫调，金色品牌（#ffcc66） |
| `light` | Ayu Light | light | value theme | 官方浅色，橙色品牌（#f29718） |
