# falcon/dark-blue 色板表

> 来源：Falcon（MIT）`dark/blue.yml`（dark）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#233348` | 中性 | 来源 editor.background |
| `--bg-surface` | `#233348` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#233348` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#233348` | 中性 | 来源 editorWidget.background |
...
| `--border` | `#344359` | 中性 | 来源 panel.border |
| `--border-strong` | `#344359` | 中性 | 继承 border |
| `--border-focus` | `#305862` | 中性 | 来源 focusBorder |
| `--card` | `#233348` | 中性 | 继承 bg-elevated |
| `--hairline` | `#344359` | 中性 | 继承 border |
...
| `--accent-secondary` | `#233348` | 强调 | 来源 button.secondaryBackground |
