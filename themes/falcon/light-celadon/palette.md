# falcon/light-celadon 色板表

> 来源：Falcon（MIT）`light/celadon.yml`（light）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#e4ecef` | 中性 | 来源 editor.background |
| `--bg-surface` | `#e4ecef` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#e4ecef` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#e4ecef` | 中性 | 来源 editorWidget.background |
...
| `--border` | `#d0d8db` | 中性 | 来源 panel.border |
| `--border-strong` | `#d0d8db` | 中性 | 继承 border |
| `--border-focus` | `#AFDBB8` | 中性 | 来源 focusBorder |
| `--card` | `#e4ecef` | 中性 | 继承 bg-elevated |
| `--hairline` | `#d0d8db` | 中性 | 继承 border |
...
| `--accent-secondary` | `#e4ecef` | 强调 | 来源 button.secondaryBackground |
