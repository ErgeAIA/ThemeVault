# falcon/light-grey 色板表

> 来源：Falcon（MIT）`light/grey.yml`（light）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#f0f4f4` | 中性 | 来源 editor.background |
| `--bg-surface` | `#f0f4f4` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#f0f4f4` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#f0f4f4` | 中性 | 来源 editorWidget.background |
| `--bg-hover` | `#FDFEFE` | 中性 | 来源 list.hoverBackground |
| `--text` | `#383A42` | 中性 | 来源 editor.foreground |
| `--text-muted` | `#aeb3c2` | 中性 | 来源 editorLineNumber.foreground |
| `--text-dim` | `#aeb3c2` | 中性 | 继承 text-muted |
| `--border` | `#e6eaea` | 中性 | 来源 panel.border |
| `--border-strong` | `#e6eaea` | 中性 | 继承 border |
| `--border-focus` | `#c7dae1` | 中性 | 来源 focusBorder |
| `--card` | `#f0f4f4` | 中性 | 继承 bg-elevated |
| `--hairline` | `#e6eaea` | 中性 | 继承 border |

## 强调色

| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--accent` | `#c7dae1` | 强调 | 来源 button.background |
| `--accent-hover` | `#c7dae1` | 强调 | 继承 accent |
| `--accent-deep` | `#c7dae1` | 强调 | 继承 accent |
| `--accent-secondary` | `#f0f4f4` | 强调 | 来源 button.secondaryBackground |
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--selection` | `#c7dae1` | 派生 | 来源 editor.selectionBackground |
| `--selection-solid` | `#c7dae1` | 派生 | 来源 selection.background |
