# falcon/light-green-islands 色板表

> 来源：Falcon（MIT）`light/green-islands.yml`（light）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#E0F2F1` | 中性 | 来源 editor.background |
| `--bg-surface` | `#E0F2F1` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#C5DEDD` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#E0F2F1` | 中性 | 来源 editorWidget.background |
| `--bg-hover` | `#F7F8FA` | 中性 | 来源 list.hoverBackground |
| `--text` | `#383A42` | 中性 | 来源 editor.foreground |
| `--text-muted` | `#aeb3c2` | 中性 | 来源 editorLineNumber.foreground |
| `--text-dim` | `#aeb3c2` | 中性 | 继承 text-muted |
| `--border` | `#d6e8e7` | 中性 | 来源 panel.border |
| `--border-strong` | `#d6e8e7` | 中性 | 继承 border |
| `--border-focus` | `#AFDBB8` | 中性 | 来源 focusBorder |
| `--card` | `#E0F2F1` | 中性 | 继承 bg-elevated |
| `--hairline` | `#d6e8e7` | 中性 | 继承 border |
...
| `--accent-secondary` | `#E0F2F1` | 强调 | 来源 button.secondaryBackground |
...
| `--activitybar-inactive` | `#4a5e84` | 派生 | 来源 activityBar.inactiveForeground |
