# falcon/light-yellow 色板表

> 来源：Falcon（MIT）`light/yellow.yml`（light）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#FFFBE8` | 中性 | 来源 editor.background |
| `--bg-surface` | `#FFFBE8` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#FFFBE8` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#FFFBE8` | 中性 | 来源 editorWidget.background |
...
| `--border` | `#f5f1de` | 中性 | 来源 panel.border |
| `--border-strong` | `#f5f1de` | 中性 | 继承 border |
| `--border-focus` | `#ddb900` | 中性 | 来源 focusBorder |
| `--card` | `#FFFBE8` | 中性 | 继承 bg-elevated |
| `--hairline` | `#f5f1de` | 中性 | 继承 border |
...
| `--accent-secondary` | `#FFFBE8` | 强调 | 来源 button.secondaryBackground |
