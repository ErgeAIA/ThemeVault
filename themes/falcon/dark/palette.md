...
> 来源：Falcon（MIT）`dark/dark.yml`（dark）。
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--bg` | `#282A36` | 中性 | 来源 editor.background |
| `--bg-surface` | `#282A36` | 中性 | 来源 editorGroupHeader.tabsBackground |
| `--bg-surface-2` | `#282A36` | 中性 | 来源 activityBar.background |
| `--bg-elevated` | `#282A36` | 中性 | 来源 editorWidget.background |
| `--bg-hover` | `#383A46` | 中性 | 来源 list.hoverBackground |
| `--text` | `#BBBBBB` | 中性 | 来源 editor.foreground |
| `--text-muted` | `#a3a5ba` | 中性 | 来源 editorLineNumber.foreground |
| `--text-dim` | `#a3a5ba` | 中性 | 继承 text-muted |
| `--border` | `#383a46` | 中性 | 来源 panel.border |
| `--border-strong` | `#383a46` | 中性 | 继承 border |
| `--border-focus` | `#305862` | 中性 | 来源 focusBorder |
| `--card` | `#282A36` | 中性 | 继承 bg-elevated |
| `--hairline` | `#383a46` | 中性 | 继承 border |
...
| `--accent-secondary` | `#282A36` | 强调 | 来源 button.secondaryBackground |
...
| 语义角色 | 颜色值 | 类型 | 备注 |
|----------|--------|------|------|
| `--ok` | `#6aab73` | 功能 | 来源 terminal.ansiBrightPURPLE |
